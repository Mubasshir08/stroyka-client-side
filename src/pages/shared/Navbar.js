...
const Navbar = () => {
    ...
    const menuItem = <>
        ...
        <li>
            <Link smooth to="/home#products">Products</Link>
        </li>
        {
            user && <li>
        ...
        <li>
            <Link smooth to="/home#summary">Summary</Link>
        </li>
        <li>
            <Link smooth to="/home#testimonial">Testimonial</Link>
        </li>
        <li className='mr-4'>
            <Link smooth to="/home#faq">Faq</Link>
        </li>

        {
            user ?
                <button onClick={handleLogOut} className="btn btn-secondary text-white border-0 rounded-sm">Sing Out</button>
                :
                <Link smooth to="/login" className="btn btn-secondary text-white border-0 rounded-sm">Login</Link>
        }

    </>

    return (
        <div className="navbar bg-primary text-secondary sticky top-0 z-[1030]">
